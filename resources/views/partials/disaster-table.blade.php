...
@if (request('start_date') && request('end_date') && $disasters->count() > 0)
...
@if (!request('start_date') && !request('end_date'))
    <p class="border-t-2 mt-4 border-t-gray-300 pt-2">{{ __("Please select a date range to filter the disasters.") }}</p>
@endif
</div>