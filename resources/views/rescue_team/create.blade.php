        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <h3 class="text-lg font-semibold mb-4">{{ __("Add New Rescue Team") }}</h3>

                    <!-- Form to Create a Rescue Team -->
                    <form action="{{ route('rescue_team.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="team_name" id="team_name"
                                ...
                                placeholder="Enter rescue team name" required>
                        </div>
